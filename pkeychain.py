...
def get_chain():
    ...
    sk = ecdsa.SigningKey.from_pem(open("private.pem").read())
    vk = sk.get_verifying_key()
    signature = sk.sign('message'.encode())
#    print (vk.to_pem())
    print (signature)
    vktopem = vk.to_pem().decode('ascii')
#    print (response)
    vk2 = ecdsa.VerifyingKey.from_pem(vktopem.encode('ascii'))
    print ('vk2')
    print (vk2)
#    print (vk2.to_pem())
    print ('signature')
    ...
    print ('b64 encoded signature')
    print (b64)
    b64 = b64.decode('ascii')
    print ('b64 decoded ascii signature')
    print (b64)
    reverse = base64.b64decode(b64.encode('ascii'))
    print ('reverse')
    print (reverse)
    print ('assert one')
    print (vk2.verify(reverse, 'message'.encode()))
    testvk = vk.to_string()
    print ('repr vk string')
    print (repr(testvk))
    vk3 = base64.b64encode(testvk).decode('ascii')
    print ('vk3 encoded b64')
    print (vk3)
    #vk3 = vk3.decode('ascii')
    #print ('vk3 decoded ascii')
    #print (vk3)
    decoded = base64.b64decode(vk3)
    print('decoded')
    print(decoded)
    vk4 = ecdsa.VerifyingKey.from_string(decoded, curve=ecdsa.NIST256p)
    print ('vk4')
    print (vk4)
    print (vk4.verify(reverse, 'message'.encode()))
    #print (vk4)
    
    #response = sk.to_string()
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The Key Blockchain now contains the following nodes:',
